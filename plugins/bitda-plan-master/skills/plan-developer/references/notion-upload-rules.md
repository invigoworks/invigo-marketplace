...
## 규칙 6: 코드 참조를 코드블록으로 변환

> `// FileName.tsx:123-456` 형태의 코드 참조는 Notion에서 일반 텍스트로 표시되면 가독성이 떨어집니다.
> 업로드 시 코드블록으로 감싸야 합니다.

```
// ❌ WRONG: 일반 텍스트로 작성
// SalesOrderDetailSheet.tsx:148-154
